...
/**
 * Created by john.osorio on 13/04/2018.
 */

public class TaskListCloseRecyclerViewFragment extends Fragment {

    private static final String TAG = TaskListCloseRecyclerViewFragment.class.getSimpleName();
